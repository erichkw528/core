...
#include <stddef.h>
#include "control_interfaces/action/detail/control__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  control_interfaces__action__Control_Goal__init(message_memory);
}

void Control_Goal__rosidl_typesupport_introspection_c__Control_Goal_fini_function(void * message_memory)
{
  control_interfaces__action__Control_Goal__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Control_Goal__rosidl_typesupport_introspection_c__Control_Goal_message_member_array[3] = {
  {
    "path",  // name
    ...
    offsetof(control_interfaces__action__Control_Goal, path),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_Goal, target_spd),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_Goal, overwrite_previous),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Control_Goal__rosidl_typesupport_introspection_c__Control_Goal_message_members = {
  ...
  3,  // number of fields
  sizeof(control_interfaces__action__Control_Goal),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_Goal)() {
  Control_Goal__rosidl_typesupport_introspection_c__Control_Goal_message_member_array[0].members_ =
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  control_interfaces__action__Control_Result__init(message_memory);
}

void Control_Result__rosidl_typesupport_introspection_c__Control_Result_fini_function(void * message_memory)
{
  control_interfaces__action__Control_Result__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Control_Result__rosidl_typesupport_introspection_c__Control_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_Result, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Control_Result__rosidl_typesupport_introspection_c__Control_Result_message_members = {
  ...
  1,  // number of fields
  sizeof(control_interfaces__action__Control_Result),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_control_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_Result)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  control_interfaces__action__Control_Feedback__init(message_memory);
}

void Control_Feedback__rosidl_typesupport_introspection_c__Control_Feedback_fini_function(void * message_memory)
{
  control_interfaces__action__Control_Feedback__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Control_Feedback__rosidl_typesupport_introspection_c__Control_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_Feedback, curr_index),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Control_Feedback__rosidl_typesupport_introspection_c__Control_Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(control_interfaces__action__Control_Feedback),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_control_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_Feedback)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  control_interfaces__action__Control_SendGoal_Request__init(message_memory);
}
...
{
  control_interfaces__action__Control_SendGoal_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Control_SendGoal_Request__rosidl_typesupport_introspection_c__Control_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_SendGoal_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_SendGoal_Request, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Control_SendGoal_Request__rosidl_typesupport_introspection_c__Control_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(control_interfaces__action__Control_SendGoal_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_control_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_SendGoal_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  control_interfaces__action__Control_SendGoal_Response__init(message_memory);
}
...
{
  control_interfaces__action__Control_SendGoal_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Control_SendGoal_Response__rosidl_typesupport_introspection_c__Control_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_SendGoal_Response, accepted),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_SendGoal_Response, stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Control_SendGoal_Response__rosidl_typesupport_introspection_c__Control_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(control_interfaces__action__Control_SendGoal_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_control_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_SendGoal_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_SendGoal_service_members = {
  "control_interfaces__action",  // service namespace
  "Control_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_SendGoal_service_type_support_handle = {
  0,
  &control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_SendGoal)() {
  if (!control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_SendGoal_service_type_support_handle.typesupport_identifier) {
    control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_SendGoal_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_SendGoal_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_SendGoal_Response)()->data;
  }

  return &control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_SendGoal_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  control_interfaces__action__Control_GetResult_Request__init(message_memory);
}
...
{
  control_interfaces__action__Control_GetResult_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Control_GetResult_Request__rosidl_typesupport_introspection_c__Control_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_GetResult_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Control_GetResult_Request__rosidl_typesupport_introspection_c__Control_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(control_interfaces__action__Control_GetResult_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_control_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_GetResult_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  control_interfaces__action__Control_GetResult_Response__init(message_memory);
}
...
{
  control_interfaces__action__Control_GetResult_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Control_GetResult_Response__rosidl_typesupport_introspection_c__Control_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_GetResult_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_GetResult_Response, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Control_GetResult_Response__rosidl_typesupport_introspection_c__Control_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(control_interfaces__action__Control_GetResult_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_control_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_GetResult_Response)() {
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_GetResult_service_members = {
  "control_interfaces__action",  // service namespace
  "Control_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_GetResult_service_type_support_handle = {
  0,
  &control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_control_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_GetResult)() {
  if (!control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_GetResult_service_type_support_handle.typesupport_identifier) {
    control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_GetResult_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_GetResult_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_GetResult_Response)()->data;
  }

  return &control_interfaces__action__detail__control__rosidl_typesupport_introspection_c__Control_GetResult_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  control_interfaces__action__Control_FeedbackMessage__init(message_memory);
}
...
{
  control_interfaces__action__Control_FeedbackMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Control_FeedbackMessage__rosidl_typesupport_introspection_c__Control_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_FeedbackMessage, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_interfaces__action__Control_FeedbackMessage, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Control_FeedbackMessage__rosidl_typesupport_introspection_c__Control_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(control_interfaces__action__Control_FeedbackMessage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_control_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_interfaces, action, Control_FeedbackMessage)() {
