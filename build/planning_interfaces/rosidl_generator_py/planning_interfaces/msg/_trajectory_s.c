...
bool planning_interfaces__msg__trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("planning_interfaces.msg._trajectory.Trajectory", full_classname_dest, 46) == 0);
  }
  planning_interfaces__msg__Trajectory * ros_message = _ros_message;
  {  // header
...
PyObject * planning_interfaces__msg__trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("planning_interfaces.msg._trajectory");
