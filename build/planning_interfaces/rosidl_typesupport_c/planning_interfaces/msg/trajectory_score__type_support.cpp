...
static const _TrajectoryScore_type_support_symbol_names_t _TrajectoryScore_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, planning_interfaces, msg, TrajectoryScore)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, planning_interfaces, msg, TrajectoryScore)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, planning_interfaces, msg, TrajectoryScore)() {
  return &::planning_interfaces::msg::rosidl_typesupport_c::TrajectoryScore_message_type_support_handle;
}
