...
static const _TrajectoryScore_type_support_symbol_names_t _TrajectoryScore_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, planning_interfaces, msg, TrajectoryScore)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, planning_interfaces, msg, TrajectoryScore)),
  }
};
...
{
  return &::planning_interfaces::msg::rosidl_typesupport_cpp::TrajectoryScore_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, planning_interfaces, msg, TrajectoryScore)() {
  return get_message_type_support_handle<planning_interfaces::msg::TrajectoryScore>();
}
