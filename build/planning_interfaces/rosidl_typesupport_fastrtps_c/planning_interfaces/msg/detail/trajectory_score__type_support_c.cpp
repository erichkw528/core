...
#include "planning_interfaces/msg/detail/trajectory_score__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryScore__ros_msg_type = planning_interfaces__msg__TrajectoryScore;
...
static uint32_t _TrajectoryScore__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_planning_interfaces__msg__TrajectoryScore(
...
{
  return max_serialized_size_planning_interfaces__msg__TrajectoryScore(
    full_bounded, 0);
}
