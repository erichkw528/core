...
#include "planning_interfaces/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const planning_interfaces::msg::Trajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  planning_interfaces::msg::Trajectory & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const planning_interfaces::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<planning_interfaces::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &planning_interfaces::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, planning_interfaces, msg, Trajectory)() {
  return &planning_interfaces::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
