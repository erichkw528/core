...
{
  new (message_memory) planning_interfaces::msg::Trajectories(_init);
}

void Trajectories_fini_function(void * message_memory)
{
  auto typed_message = static_cast<planning_interfaces::msg::Trajectories *>(message_memory);
  typed_message->~Trajectories();
}

size_t size_function__Trajectories__trajectories(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<planning_interfaces::msg::Trajectory> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<planning_interfaces::msg::Trajectory> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<planning_interfaces::msg::Trajectory> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Trajectories_message_member_array[1] = {
  {
    "trajectories",  // name
    ...
    offsetof(planning_interfaces::msg::Trajectories, trajectories),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Trajectories_message_members = {
  "planning_interfaces::msg",  // message namespace
  "Trajectories",  // message name
  1,  // number of fields
  sizeof(planning_interfaces::msg::Trajectories),
...
{
  return &::planning_interfaces::msg::rosidl_typesupport_introspection_cpp::Trajectories_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, planning_interfaces, msg, Trajectories)() {
  return &::planning_interfaces::msg::rosidl_typesupport_introspection_cpp::Trajectories_message_type_support_handle;
}
