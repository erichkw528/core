...
#define NODE_MAIN_LOGGER_NAME "default_behavior_planner_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libDEFAULT_BT.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<roar::planning::behavior_planning::impl::DefaultBehaviorPlanner>";
