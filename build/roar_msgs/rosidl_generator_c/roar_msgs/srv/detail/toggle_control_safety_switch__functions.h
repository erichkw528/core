...
#ifndef ROAR_MSGS__SRV__DETAIL__TOGGLE_CONTROL_SAFETY_SWITCH__FUNCTIONS_H_
#define ROAR_MSGS__SRV__DETAIL__TOGGLE_CONTROL_SAFETY_SWITCH__FUNCTIONS_H_
...
/// Initialize srv/ToggleControlSafetySwitch message.
/**
...
/// Finalize srv/ToggleControlSafetySwitch message.
/**
...
/// Create srv/ToggleControlSafetySwitch message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roar_msgs__srv__ToggleControlSafetySwitch_Request__init().
...
/// Destroy srv/ToggleControlSafetySwitch message.
/**
 * It calls
 * roar_msgs__srv__ToggleControlSafetySwitch_Request__fini()
...
/// Initialize array of srv/ToggleControlSafetySwitch messages.
/**
...
/// Finalize array of srv/ToggleControlSafetySwitch messages.
/**
 * It calls
 * roar_msgs__srv__ToggleControlSafetySwitch_Request__fini()
...
/// Create array of srv/ToggleControlSafetySwitch messages.
/**
 * It allocates the memory for the array and calls
 * roar_msgs__srv__ToggleControlSafetySwitch_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ToggleControlSafetySwitch messages.
/**
 * It calls
 * roar_msgs__srv__ToggleControlSafetySwitch_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roar_msgs__srv__ToggleControlSafetySwitch_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roar_msgs
...
/**
 * It calls
 * roar_msgs__srv__ToggleControlSafetySwitch_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_roar_msgs
...
/**
 * It allocates the memory for the array and calls
 * roar_msgs__srv__ToggleControlSafetySwitch_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roar_msgs
...
/**
 * It calls
 * roar_msgs__srv__ToggleControlSafetySwitch_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROAR_MSGS__SRV__DETAIL__TOGGLE_CONTROL_SAFETY_SWITCH__FUNCTIONS_H_
