...
bool roar_msgs__msg__vehicle_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("roar_msgs.msg._vehicle_control.VehicleControl", full_classname_dest, 45) == 0);
  }
  roar_msgs__msg__VehicleControl * ros_message = _ros_message;
  {  // header
...
PyObject * roar_msgs__msg__vehicle_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("roar_msgs.msg._vehicle_control");
