...
bool roar_msgs__msg__vehicle_status__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool roar_msgs__msg__vehicle_control__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * roar_msgs__msg__vehicle_control__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool roar_msgs__msg__vehicle_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("roar_msgs.msg._vehicle_state.VehicleState", full_classname_dest, 41) == 0);
  }
  roar_msgs__msg__VehicleState * ros_message = _ros_message;
  {  // header
  ...
  {  // vehicle_status
    ...
    if (!roar_msgs__msg__vehicle_status__convert_from_py(field, &ros_message->vehicle_status)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // vehicle_control
    PyObject * field = PyObject_GetAttrString(_pymsg, "vehicle_control");
    if (!field) {
      return false;
    }
    if (!roar_msgs__msg__vehicle_control__convert_from_py(field, &ros_message->vehicle_control)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * roar_msgs__msg__vehicle_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("roar_msgs.msg._vehicle_state");
  ...
  {  // vehicle_status
    PyObject * field = NULL;
    field = roar_msgs__msg__vehicle_status__convert_to_py(&ros_message->vehicle_status);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // vehicle_control
    PyObject * field = NULL;
    field = roar_msgs__msg__vehicle_control__convert_to_py(&ros_message->vehicle_control);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "vehicle_control", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
