...
#include "roar_msgs/msg/detail/vehicle_control__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleControl__ros_msg_type = roar_msgs__msg__VehicleControl;
...
static uint32_t _VehicleControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roar_msgs__msg__VehicleControl(
...
{
  return max_serialized_size_roar_msgs__msg__VehicleControl(
    full_bounded, 0);
}
