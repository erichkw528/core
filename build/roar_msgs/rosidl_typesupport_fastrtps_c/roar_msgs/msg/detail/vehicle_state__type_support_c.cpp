...
#include "roar_msgs/msg/detail/vehicle_state__rosidl_typesupport_fastrtps_c.h"
...
#include "roar_msgs/msg/detail/vehicle_control__functions.h"  // vehicle_control
#include "roar_msgs/msg/detail/vehicle_status__functions.h"  // vehicle_status
...
size_t get_serialized_size_roar_msgs__msg__VehicleControl(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_roar_msgs__msg__VehicleControl(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roar_msgs, msg, VehicleControl)();
...
using _VehicleState__ros_msg_type = roar_msgs__msg__VehicleState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: vehicle_status
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, roar_msgs, msg, VehicleStatus
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: vehicle_control
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, roar_msgs, msg, VehicleControl
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->vehicle_control, cdr))
    {
      return false;
    }
  }
...
size_t get_serialized_size_roar_msgs__msg__VehicleState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VehicleState__ros_msg_type * ros_message = static_cast<const _VehicleState__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_roar_msgs__msg__VehicleStatus(
  ...
  current_alignment += get_serialized_size_roar_msgs__msg__VehicleControl(
...
static uint32_t _VehicleState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roar_msgs__msg__VehicleState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roar_msgs
size_t max_serialized_size_roar_msgs__msg__VehicleState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: vehicle_status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_roar_msgs__msg__VehicleStatus(
        full_bounded, current_alignment);
    }
  }
  // member: global_path
  ...
  // member: vehicle_control
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_roar_msgs__msg__VehicleControl(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_roar_msgs__msg__VehicleState(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roar_msgs, msg, VehicleState)() {
