...
#include "roar_msgs/msg/detail/vehicle_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const roar_msgs::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roar_msgs::msg::VehicleStatus *>(
    untyped_ros_message);
...
{
  return &roar_msgs::msg::typesupport_fastrtps_cpp::_VehicleStatus__handle;
}
