...
{
  new (message_memory) planning_interfaces::msg::TrajectoryScore(_init);
}

void TrajectoryScore_fini_function(void * message_memory)
{
  auto typed_message = static_cast<planning_interfaces::msg::TrajectoryScore *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectoryScore_message_member_array[3] = {
  {
    ...
    offsetof(planning_interfaces::msg::TrajectoryScore, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planning_interfaces::msg::TrajectoryScore, raw_score),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planning_interfaces::msg::TrajectoryScore, scale),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectoryScore_message_members = {
  ...
  3,  // number of fields
  sizeof(planning_interfaces::msg::TrajectoryScore),
...
{
  return &::planning_interfaces::msg::rosidl_typesupport_introspection_cpp::TrajectoryScore_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, planning_interfaces, msg, TrajectoryScore)() {
  return &::planning_interfaces::msg::rosidl_typesupport_introspection_cpp::TrajectoryScore_message_type_support_handle;
}
