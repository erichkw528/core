...
#ifndef PLANNING_INTERFACES__SRV__DETAIL__LOAD_MAP__FUNCTIONS_H_
#define PLANNING_INTERFACES__SRV__DETAIL__LOAD_MAP__FUNCTIONS_H_
 ...
 * calls
 * planning_interfaces__srv__LoadMap_Request__init().
...
/**
 * It calls
 * planning_interfaces__srv__LoadMap_Request__fini()
 ...
 * planning_interfaces__srv__LoadMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * planning_interfaces__srv__LoadMap_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * planning_interfaces__srv__LoadMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_planning_interfaces
...
/**
 * It calls
 * planning_interfaces__srv__LoadMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_planning_interfaces
...
/**
 * It allocates the memory for the array and calls
 * planning_interfaces__srv__LoadMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_planning_interfaces
...
/**
 * It calls
 * planning_interfaces__srv__LoadMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PLANNING_INTERFACES__SRV__DETAIL__LOAD_MAP__FUNCTIONS_H_
