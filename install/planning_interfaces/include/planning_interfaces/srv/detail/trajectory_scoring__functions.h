...
#ifndef PLANNING_INTERFACES__SRV__DETAIL__TRAJECTORY_SCORING__FUNCTIONS_H_
#define PLANNING_INTERFACES__SRV__DETAIL__TRAJECTORY_SCORING__FUNCTIONS_H_
...
/// Initialize srv/TrajectoryScoring message.
/**
...
/// Finalize srv/TrajectoryScoring message.
/**
...
/// Create srv/TrajectoryScoring message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * planning_interfaces__srv__TrajectoryScoring_Request__init().
...
/// Destroy srv/TrajectoryScoring message.
/**
 * It calls
 * planning_interfaces__srv__TrajectoryScoring_Request__fini()
...
/// Initialize array of srv/TrajectoryScoring messages.
/**
...
/// Finalize array of srv/TrajectoryScoring messages.
/**
 * It calls
 * planning_interfaces__srv__TrajectoryScoring_Request__fini()
...
/// Create array of srv/TrajectoryScoring messages.
/**
 * It allocates the memory for the array and calls
 * planning_interfaces__srv__TrajectoryScoring_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TrajectoryScoring messages.
/**
 * It calls
 * planning_interfaces__srv__TrajectoryScoring_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * planning_interfaces__srv__TrajectoryScoring_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_planning_interfaces
...
/**
 * It calls
 * planning_interfaces__srv__TrajectoryScoring_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_planning_interfaces
...
/**
 * It allocates the memory for the array and calls
 * planning_interfaces__srv__TrajectoryScoring_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_planning_interfaces
...
/**
 * It calls
 * planning_interfaces__srv__TrajectoryScoring_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PLANNING_INTERFACES__SRV__DETAIL__TRAJECTORY_SCORING__FUNCTIONS_H_
