...
class Metaclass_LoadMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'planning_interfaces.srv.LoadMap')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from planning_interfaces.srv import _load_map
...
class LoadMap(metaclass=Metaclass_LoadMap):
    from planning_interfaces.srv._load_map import LoadMap_Request as Request
    from planning_interfaces.srv._load_map import LoadMap_Response as Response
