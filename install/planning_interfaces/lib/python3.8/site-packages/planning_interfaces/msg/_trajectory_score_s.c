...
bool planning_interfaces__msg__trajectory_score__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("planning_interfaces.msg._trajectory_score.TrajectoryScore", full_classname_dest, 57) == 0);
  }
  planning_interfaces__msg__TrajectoryScore * ros_message = _ros_message;
  {  // name
...
PyObject * planning_interfaces__msg__trajectory_score__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("planning_interfaces.msg._trajectory_score");
